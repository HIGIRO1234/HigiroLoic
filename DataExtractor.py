...
class DataExtractor:
    def __init__(self):
        ...
        # URL pattern
        self.url_pattern = r'https?:\/\/(www\.)?[-a-zA-Z0-9@:%.\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%\+.~#?&//=]*)'
...
def main():
    ...
    while True:
        ...
        extraction_type = pattern_mapping.get(choice)
        results, error = extractor.extract_with_validation(text, extraction_type)
